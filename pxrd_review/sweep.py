...
# ----------------------------------------------------------------------------- discovery
# discover() now lives in cell_lambda_check (shared by the GUI / annotate_review / sweep, so all
# entry points find docx recursively under the root). Re-exported here for back-compat.
discover = C.discover
